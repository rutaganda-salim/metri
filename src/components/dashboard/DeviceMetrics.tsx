...
export function DeviceMetrics({ trackingId, dateRange }: DeviceMetricsProps) {
  ...
  return (
    <div className="flex items-center justify-center w-5 h-5 text-yellow-500">
      <svg viewBox="0 0 24 24" fill="currentColor" stroke="none" className="h-4 w-4">
        <path d="M12.5,1.5c-0.8,0-1.5,0.3-2.1,0.9S9.5,3.7,9.5,4.5c0,0.3,0,0.7,0.1,1.1c0.1,0.4,0.3,0.8,0.6,1.1s0.6,0.5,1,0.7 c0.4,0.1,0.8,0.2,1.2,0.1s0.8-0.2,1.2-0.5c0.4-0.3,0.6-0.6,0.8-1c0.2-0.4,0.3-0.8,0.3-1.2s-0.1-0.8-0.3-1.2c-0.2-0.4-0.4-0.7-0.8-1c-0.4-0.3-0.8-0.5-1.2-0.7s-0.8-0.1-1.2,0.1s-0.8,0.5-1,0.9s-0.2,0.7-0.1,1.1c0.1,0.4,0.3,0.8,0.6,1.1s0.6,0.5,1,0.7c0.4,0.1,0.8,0.2,1.2,0.1s0.8-0.2,1.2-0.5c0.4-0.3,0.6-0.6,0.8-1c0.2-0.4,0.3-0.8,0.3-1.2s-0.1-0.8-0.3-1.2c-0.2-0.4-0.4-0.7-0.8-1c-0.4-0.3-0.8-0.5-1.2-0.7s-0.8-0.1-1.2,0.1s-0.8,0.5-1,0.9s-0.2,0.7-0.1,1.1c0.1,0.4,0.3,0.8,0.6,1.1s0.6,0.5,1,0.7c0.4,0.1,0.8,0.2,1.2,0.1s0.8-0.2,1.2-0.5c0.4-0.3,0.6-0.6,0.8-1c0.2-0.4,0.3-0.8,0.3-1.2s-0.1-0.8-0.3-1.2c-0.2-0.4-0.4-0.7-0.8-1c-0.4-0.3-0.8-0.5-1.2-0.7s-0.8-0.1-1.2,0.1s-0.8,0.5-1,0.9s-0.2,0.7-0.1,1.1c0.1,0.4,0.3,0.8,0.6,1.1s0.6,0.5,1,0.7c0.4,0.1,0.8,0.2,1.2,0.1s0.8-0.2,1.2-0.5c0.4-0.3,0.6-0.6,0.8-1c0.2-0.4,0.3-0.8,0.3-1.2S13.2,1.9,13,1.5z"/>
      </svg>
    </div>
  );
} else {
